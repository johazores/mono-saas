      ...
      <div className="flex w-full flex-col items-center justify-center bg-[var(--theme-bg)] px-6 py-16 lg:w-1/2">
        <div className="w-full max-w-[380px]">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label htmlFor="name" className="mb-2 block text-sm font-medium text-[var(--theme-text)]">
                Full name
              </label>
              <input
                id="name"
            ...
            <div>
              ...
              <input
                ...
                placeholder="••••••••"
              />
              <p className="mt-1.5 text-xs text-[var(--theme-muted)]">Must be at least 8 characters</p>
            </div>
          ...
          <p className="mt-6 text-center text-sm text-[var(--theme-muted)]">
            ...
            <Link href="/user-login" className="font-semibold text-[var(--theme-primary)] hover:underline">
              Sign in
            </Link>
          </p>
        </div>
